...
#define CYTTSP4_FW_UPGRADE \
	(defined(CYTTSP4_PLATFORM_FW_UPGRADE) \
	|| defined(CYTTSP4_BINARY_FW_UPGRADE))

#define CYTTSP4_TTCONFIG_UPGRADE \
	(defined(CYTTSP4_PLATFORM_TTCONFIG_UPGRADE) \
	|| defined(CYTTSP4_MANUAL_TTCONFIG_UPGRADE))
...
#ifdef CYTTSP4_BINARY_FW_UPGRADE
	struct completion builtin_bin_fw_complete;
	int builtin_bin_fw_status;
#endif
#ifdef CYTTSP4_MANUAL_TTCONFIG_UPGRADE
...
#endif /* CYTTSP4_PLATFORM_FW_UPGRADE */
...
#endif /* CYTTSP4_BINARY_FW_UPGRADE */
...
#endif /* CYTTSP4_PLATFORM_TTCONFIG_UPGRADE */
...
#endif /* CYTTSP4_MANUAL_TTCONFIG_UPGRADE */
